...
const _hoisted_18$3 = { class: "flex items-start justify-between gap-2" };
                            ...
                            createBaseVNode("div", _hoisted_22$2, [
                              (card.status === 'in_use')
                                ...
                                : (card.status === 'recycling')
                                  ...
                                  : (card.status === 'error')
                                    ? (openBlock(), createElementBlock("span", _hoisted_23, "需人工处理"))
                                    : (!card.enabled)
...
const _hoisted_18$2 = { class: "text-ink" };
                    ...
                    createBaseVNode("div", _hoisted_5$8, [
                      ...
                      createBaseVNode("dl", _hoisted_16$4, [
                        createBaseVNode("div", _hoisted_17$4, [
                          ...
                          createBaseVNode("dd", _hoisted_18$2, toDisplayString(relativeTime(lease.value.lastActivityAt)), 1)
                        ]),
...
const _hoisted_16$3 = { class: "max-h-48 overflow-auto rounded-lg border border-hairline" };
const _hoisted_17$3 = { class: "font-medium" };
const _hoisted_18$1 = { class: "text-mid-gray" };
const _hoisted_19$1 = { class: "font-medium" };
const _hoisted_20 = { class: "text-mid-gray" };
const _hoisted_21 = { class: "text-ember" };
const _hoisted_22 = {
  key: 1,
  class: "text-xs text-mid-gray"
};
...
/** 触发浏览器下载（a 需入 DOM 且延后 revoke，否则部分浏览器会中断下载）。 */
...
function downloadAccountTemplate() {
  downloadBlob('accounts-template.csv', accountsCsvTemplate());
}
      ...
      createVNode(_sfc_main$B, {
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_14$3, [
            ...
            _cache[41] || (_cache[41] = createBaseVNode("p", { class: "text-xs text-mid-gray" }, "必需列：账号编号、科应账号。密码由系统托管，导入后管理员可经「重置密码」生成。", -1)),
                  ...
                  createBaseVNode("div", _hoisted_16$3, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(importRows.value, (r) => {
                      return (openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("span", _hoisted_17$3, toDisplayString(r.code), 1),
                        createBaseVNode("span", _hoisted_18$1, toDisplayString(r.username), 1),
                        _cache[40] || (_cache[40] = createBaseVNode("span", { class: "text-green-600" }, "可导入", -1))
                      ]))
                    }), 128)),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(importFailed.value, (r) => {
                      return (openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("span", _hoisted_19$1, toDisplayString(r.code || '(空)'), 1),
                        createBaseVNode("span", _hoisted_20, toDisplayString(r.username || ''), 1),
                        createBaseVNode("span", _hoisted_21, toDisplayString(r.errors.join('；')), 1)
                      ]))
                    }), 128))
                  ]),
                  createBaseVNode("p", {
            ...
            (importResult.value && importResult.value.created > 0)
              ? (openBlock(), createElementBlock("p", _hoisted_22, " 已导入 " + toDisplayString(importResult.value.created) + " 条。导入账号的密码为系统占位值， 需逐个执行「重置密码」生成真实密码后方可领用。 ", 1))
              : createCommentVNode("", true)
          ])
        ]),
        _: 1
...
const _hoisted_4$4 = { class: "flex items-center justify-end gap-2 whitespace-nowrap" };
const _hoisted_5$4 = {
  key: 0,
...
const _hoisted_7$4 = { class: "max-h-[50dvh] overflow-y-auto" };
const _hoisted_8$3 = { class: "w-full text-left text-sm" };
const _hoisted_9$3 = { class: "py-1.5 pr-2 tabular-nums text-mid-gray" };
const _hoisted_10$2 = { class: "py-1.5 pr-2 font-medium" };
const _hoisted_11$2 = { class: "py-1.5 pr-2" };
const _hoisted_12$2 = { class: "py-1.5 pr-2 text-mid-gray" };
const _hoisted_13$2 = { class: "py-1.5 pr-2" };
const _hoisted_14$2 = { class: "py-1.5" };
const _hoisted_15$2 = {
  key: 0,
    ...
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_1$6, [
        createBaseVNode("div", _hoisted_2$4, [
          _cache[22] || (_cache[22] = createBaseVNode("h1", { class: "text-xl font-semibold leading-7 tracking-normal text-ink sm:text-2xl sm:leading-8" }, " 用户管理 ", -1)),
        ...
        default: withCtx(() => [
          createBaseVNode("form", {
            ...
            createBaseVNode("div", null, [
              ...
              (verifyError.value)
                ? (openBlock(), createElementBlock("p", _hoisted_5$4, toDisplayString(verifyError.value), 1))
                : createCommentVNode("", true)
            ])
          ], 32)
        ]),
        ...
        default: withCtx(() => [
          createBaseVNode("form", {
            ...
            createBaseVNode("div", null, [
              ...
              (resetResult.value)
                ? (openBlock(), createElementBlock("p", _hoisted_6$4, "✓ 密码已重置"))
                : createCommentVNode("", true)
            ])
          ], 32)
        ]),
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_7$4, [
            createBaseVNode("table", _hoisted_8$3, [
              _cache[47] || (_cache[47] = createBaseVNode("thead", { class: "sticky top-0 bg-paper" }, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(importRows.value, (row) => {
                  return (openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", _hoisted_9$3, toDisplayString(row.index), 1),
                    createBaseVNode("td", _hoisted_10$2, toDisplayString(row.username || '—'), 1),
                    createBaseVNode("td", _hoisted_11$2, toDisplayString(row.displayName || '—'), 1),
                    createBaseVNode("td", _hoisted_12$2, toDisplayString(row.department || '—'), 1),
                    createBaseVNode("td", _hoisted_13$2, toDisplayString(row.role), 1),
                    createBaseVNode("td", _hoisted_14$2, [
                      (row.imported)
                        ? (openBlock(), createElementBlock("span", _hoisted_15$2, "✓ 已导入"))
                        : (row.errors.length === 0)
                          ? (openBlock(), createElementBlock("span", _hoisted_16$2, "✓ 可导入"))
                          : (openBlock(), createElementBlock("span", _hoisted_17$2, toDisplayString(row.errors.join('；')), 1))
                    ])
                  ]))
                }), 128))
              ])
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/manual', name: 'manual', component: () => __vitePreload(() => import('./ManualPage-CO7wms_V.js'),true              ?[]:void 0) },
    { path: '/admin', redirect: '/admin/dashboard' },
    // 数据看板懒加载：echarts 体积较大，仅管理员访问看板时按需加载。
    {
      path: '/admin/dashboard',
      name: 'admin-dashboard',
      component: () => __vitePreload(() => import('./DashboardPage-C3whfFwc.js'),true              ?[]:void 0),
